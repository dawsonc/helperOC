...
dSat = Satellite2D([0, 0, 0, 0], dMax); %do dStep3 here

% Put grid and dynamic systems into schemeData
schemeData.grid = g;
schemeData.dynSys = dSat;
...
if compTraj
  ...
  if value <= 0 %if initial state is in BRS/BRT
    ...
    dSat.x = xinit; %set initial state of the dubins car
    ...
    [traj, traj_tau] = ...
      computeOptTraj(g, dataTraj, tau2, dSat, TrajextraArgs);
